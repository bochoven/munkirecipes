...
# primary_interface_name (string): BSD representation of the primary interface
# primary_ip_address (string): IPv4 ip address of primary interface

# Usage:
# To have awesome_package install only when the machines' primary interface is en0
# use the following condition:
#
# <dict>
#   <key>condition</key>
#   <string>primary_interface_name == 'en0'</string>
